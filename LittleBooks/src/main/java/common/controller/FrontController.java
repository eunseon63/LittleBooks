...
@WebServlet(
		...
		urlPatterns = { "*.go" }, 
		initParams = { 
				@WebInitParam(name = "propertyConfig", value = "/Users/eunseon/git/LittleBooks/LittleBooks/src/main/webapp/WEB-INF/Command.properties", description = "*.go 에 대한 클래스의 매핑파일")
		})
